...
downstream — credential theft, malware execution, fraudulent approval — depends on that first,
narrower failure.
...
- **Targeted phishing** aimed at a specific person or role, often impersonating an executive or
  known vendor — covered in full on its own page, [Business Email
  Compromise](../business-email-compromise/), because the mechanics and stakes are different enough
