...
- [Ransomware](../ransomware/): a frequent downstream consequence once an insider's access, whether
  misused directly or compromised by someone else, reaches far enough into an environment.
