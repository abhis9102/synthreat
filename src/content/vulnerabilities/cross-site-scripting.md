...
- **[Session Hijacking](../../attacks/session-hijacking/)**: the most common real-world consequence
  of a successful XSS finding, where a script reads and exfiltrates an authenticated session.
